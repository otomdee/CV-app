export default function EduEditState({visible, handleVisibleChange, editableExpArr, handleFieldDelete, expNewForm, populateForm}) {
    ...
    return ( <div className="edit-edu-wrap">
                    ...
                    return (<div className="edit-edu-Div" key={item.id}>
                                ...
                                <div>
                                    <div className="edit-edu-text">
                                        <span className="edit-edu-degree">{item.jobTitle}</span>
                                        <span className="edit-edu-uni">{item.employer}</span>
                                        <span className="edit-edu-dates">{startDate + " - " + endDate}</span>
                                    </div>
                                    <div className="edit-edu-Buttons">
                                        <svg onClick={() => populateForm(item.id)} xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#e8eaed"><path d="M200-200h57l391-391-57-57-391 391v57Zm-80 80v-170l528-527q12-11 26.5-17t30.5-6q16 0 31 6t26 18l55 56q12 11 17.5 26t5.5 30q0 16-5.5 30.5T817-647L290-120H120Zm640-584-56-56 56 56Zm-141 85-28-29 57 57-29-28Z"/></svg>
                ...
                <div className="edit-edu-footer">
                    <hr />
                    <button id="edit-edu-button" onClick={expNewForm}>
